...
import { Building, Lock, User, Save, ShieldCheck, Eye, EyeOff } from "lucide-react"
    ...
    return (
        <div className="space-y-8 container mx-auto">
            ...
            <div className="bg-er-primary p-10 rounded-3xl flex flex-col gap-3 shadow-lg shadow-er-primary/20">
                ...
                <p className="text-blue-100 mt-1 font-medium">Manage your personal information, company details, and security.</p>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="w-full lg:w-72 flex-shrink-0">
                    <div className="bg-white rounded-3xl p-4 border border-slate-100 shadow-sm space-y-2 sticky top-8">
                        ...
                        <button
                            ...
                            className={`w-full flex items-center gap-3 px-4 py-4 rounded-2xl font-bold text-sm tracking-wide transition-all ${activeTab === "company" ? "bg-er-primary/5 text-er-primary" : "text-slate-500 hover:bg-slate-50 hover:text-slate-900"}`}
                        >
                ...
                <div className="flex-1">
                    ...
                    {activeTab === "company" && (
                        <form onSubmit={handleProfileSubmit} className="bg-white rounded-3xl p-8 border border-slate-100 shadow-sm space-y-8">
                            <div>
                                <h3 className="text-xl font-bold text-slate-900 mb-6 font-display">Company Profile</h3>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
