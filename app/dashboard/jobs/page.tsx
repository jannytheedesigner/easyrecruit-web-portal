    ...
    <div className="space-y-8">
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Track, manage and optimize your job postings</p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-2xl p-6">
          ...
          <div className="mt-4 text-xs text-blue-600">All job postings</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-2xl p-6">
          ...
          <div className="mt-4 text-xs text-green-600">Active opportunities</div>
        </div>

        <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 border border-yellow-200 rounded-2xl p-6">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-sm text-yellow-700 font-medium">In Draft</div>
              <div className="text-3xl font-bold text-yellow-900 mt-1">{stats.drafts}</div>
            </div>
            <div className="p-3 bg-yellow-500 text-white rounded-xl">
              <Clock className="w-6 h-6" />
            </div>
          </div>
          <div className="mt-4 text-xs text-yellow-600">Pending publications</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-2xl p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="text-3xl font-bold text-gray-900 mt-1">{stats.closed}</div>
            </div>
            <div className="p-3 bg-gray-500 text-white rounded-xl">
              <Users className="w-6 h-6" />
            </div>
          </div>
          <div className="mt-4 text-xs text-gray-600">Filled positions</div>
        </div>
      </div>
