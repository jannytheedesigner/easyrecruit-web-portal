...
import { UsersIcon, Search, Filter, MapPin, Briefcase, Star, Award, Calendar, Mail, Phone, ExternalLink, Eye, MessageSquare, Bookmark, BookmarkCheck, ChevronRight, Download, Sparkles } from "lucide-react"
        ...
        <div>
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Discover and connect with top professionals</p>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-2xl p-6">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-sm text-blue-700 font-medium">Total Talent</div>
          ...
          <div className="mt-4 text-xs text-blue-600">Professionals available</div>
        </div>

        <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-2xl p-6">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-sm text-green-700 font-medium">Immediate Start</div>
              <div className="text-3xl font-bold text-green-900 mt-1">{stats.available}</div>
            </div>
            <div className="p-3 bg-green-500 text-white rounded-xl">
              <Calendar className="w-6 h-6" />
            </div>
          </div>
          <div className="mt-4 text-xs text-green-600">Ready to work now</div>
        </div>

        <div className="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-2xl p-6">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-sm text-purple-700 font-medium">Top Rated</div>
              <div className="text-3xl font-bold text-purple-900 mt-1">{stats.premium}</div>
            </div>
            <div className="p-3 bg-purple-500 text-white rounded-xl">
              <Award className="w-6 h-6" />
            </div>
          </div>
          <div className="mt-4 text-xs text-purple-600">4.5+ star ratings</div>
        </div>

        <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 border border-yellow-200 rounded-2xl p-6">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-sm text-yellow-700 font-medium">Saved Talent</div>
              <div className="text-3xl font-bold text-yellow-900 mt-1">{stats.favorites}</div>
            </div>
            <div className="p-3 bg-yellow-500 text-white rounded-xl">
              <BookmarkCheck className="w-6 h-6" />
            </div>
          </div>
          <div className="mt-4 text-xs text-yellow-600">Your favorites</div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm">
        ...
        <div className="flex flex-wrap gap-3 mt-6">
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${filterRole === "all" ? "bg-primary text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"}`}
          >
            All Talent
          </button>
          ...
          <button className="px-4 py-2 rounded-lg text-sm font-medium bg-yellow-50 text-yellow-700 border border-yellow-200 hover:bg-yellow-100 transition-colors">
            Top Rated (4.5+)
          </button>
          <button className="px-4 py-2 rounded-lg text-sm font-medium bg-green-50 text-green-700 border border-green-200 hover:bg-green-100 transition-colors">
            Remote Only
          </button>
          <button className="px-4 py-2 rounded-lg text-sm font-medium bg-purple-50 text-purple-700 border border-purple-200 hover:bg-purple-100 transition-colors">
            Premium Talent
          </button>
        </div>
      </div>
            ...
            >
              ...
              <div className="relative p-6">
                <button
                  ...
                  className="absolute top-4 right-4 z-10 p-2 bg-white border border-gray-200 rounded-full shadow-sm hover:shadow-md transition-all"
                >
                  {talent.is_favorite ? (
                ...
                <div className="flex items-start gap-4 mb-4">
                  <div className={`w-16 h-16 rounded-full flex items-center justify-center flex-shrink-0 ${talent.avatar_color} text-white font-bold text-xl`}>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="font-semibold text-gray-900">
                      ${talent.salary_expectation?.toLocaleString()}/year
                    </div>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <div className="font-semibold text-gray-900">{talent.profile_views}</div>
                  </div>
                </div>
              </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  <th className="text-left py-4 px-6 text-sm font-semibold text-gray-900">Talent</th>
