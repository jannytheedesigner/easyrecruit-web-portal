...
export const JobseekerHero = ({ caption, title, subtitle, className }: JobseekerHeroProps) => {
    return (
        <section className={cn(
            "relative w-full overflow-hidden rounded-3xl bg-er-dark py-20 lg:py-20",
            className
        )}>
            <Image src="/brand-assets/visual-assets/illustrations/interview.jpg" width={400} height={400} alt="hero-section" className="absolute object-cover inset-0 w-full h-full" unoptimized />
            ...
            <section className="text-white relative z-40">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Button size="lg" className="bg-er-complimentary hover:bg-er-complimentary/80 text-er-white">
